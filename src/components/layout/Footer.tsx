...
export function Footer() {
  ...
  return (
    <footer className="relative mt-10">
      ...
      {/* ---------------------------------------------------- main footer */}
      <div className="relative mt-20 border-t border-white/[0.07] bg-ink-950/60 pb-8 pt-16 backdrop-blur-xl">
        <div className="container-x">
          <div className="grid gap-10 lg:grid-cols-[1.4fr_1fr_1fr_1fr] lg:gap-8">
            ...
            <div>
              ...
              <p className="mt-5 max-w-sm text-[12.5px] leading-relaxed text-slate-400">
                The official Training & Placement platform of the university. Verified recruiters, AI-scored
                resumes and every campus opportunity on one live timeline.
              </p>
